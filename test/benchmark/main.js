  ...
  function AddScore(score) {
    ...
    if (success) {
      status.innerHTML = "BitcoinBench Score: " + score;
    } else {
      status.innerHTML = "BitcoinBench Score (incomplete): " + score;
    }
  ...
  function Run() {
    document.getElementById("main-banner").innerHTML = "Running BitcoinBench...";
  ...
  function CheckCompatibility() {
    ...
    document.getElementById('main-banner').addEventListener('click', Run);
  }
